...
public:
  ...
  const Rot3& attitude(OptionalJacobian<3, 9> H = std::nullopt) const;
  const Point3& position(OptionalJacobian<3, 9> H = std::nullopt) const;
  const Velocity3& velocity(OptionalJacobian<3, 9> H = std::nullopt) const;
  ...
  Velocity3 bodyVelocity(OptionalJacobian<3, 9> H = std::nullopt) const;
  ...
  NavState retract(const Vector9& v, //
      OptionalJacobian<9, 9> H1 = std::nullopt, OptionalJacobian<9, 9> H2 =
          std::nullopt) const;
  ...
  Vector9 coriolis(double dt, const Vector3& omega, bool secondOrder = false,
      OptionalJacobian<9, 9> H = std::nullopt) const;
  ...
  Vector9 correctPIM(const Vector9& pim, double dt, const Vector3& n_gravity,
      const std::optional<Vector3>& omegaCoriolis, bool use2ndOrderCoriolis =
          false, OptionalJacobian<9, 9> H1 = std::nullopt,
      OptionalJacobian<9, 9> H2 = std::nullopt) const;
