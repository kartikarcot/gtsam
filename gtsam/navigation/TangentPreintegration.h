...
public:
  ...
  static Vector9 UpdatePreintegrated(const Vector3& a_body,
                                     ...
                                     OptionalJacobian<9, 9> A = std::nullopt,
                                     OptionalJacobian<9, 3> B = std::nullopt,
                                     OptionalJacobian<9, 3> C = std::nullopt);
  ...
  Vector9 biasCorrectedDelta(const imuBias::ConstantBias& bias_i,
      OptionalJacobian<9, 6> H = std::nullopt) const override;
  ...
  static Vector9 Compose(const Vector9& zeta01, const Vector9& zeta12,
                         ...
                         OptionalJacobian<9, 9> H2 = std::nullopt);
