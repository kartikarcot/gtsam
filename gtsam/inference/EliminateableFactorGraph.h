...
namespace gtsam {
  ...
  public:
    ...
    typedef std::optional<const std::reference_wrapper<const VariableIndex>> OptionalVariableIndex;
    ...
    boost::shared_ptr<BayesNetType> eliminateSequential(
      OptionalOrderingType orderingType = std::nullopt,
      const Eliminate& function = EliminationTraitsType::DefaultEliminate,
      OptionalVariableIndex variableIndex = std::nullopt) const;
     ...
     *  VariableIndex varIndex(graph); // Build variable index
     *  Data data = otherFunctionUsingVariableIndex(graph, varIndex); // Other code that uses variable index
     *  boost::shared_ptr<GaussianBayesTree> result = graph.eliminateMultifrontal(EliminateQR, std::nullopt, varIndex);
     *  \endcode
     *  */
  ...
  public:
    ...
    boost::shared_ptr<BayesNetType> GTSAM_DEPRECATED eliminateSequential(
      const Eliminate& function,
      OptionalVariableIndex variableIndex = std::nullopt,
      OptionalOrderingType orderingType = std::nullopt) const {
