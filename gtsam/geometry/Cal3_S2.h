...
class GTSAM_EXPORT Cal3_S2 : public Cal3 {
 public:
   ...
   */
  Point2 uncalibrate(const Point2& p, OptionalJacobian<2, 5> Dcal = std::nullopt,
                     OptionalJacobian<2, 2> Dp = std::nullopt) const;
   ...
   */
  Point2 calibrate(const Point2& p, OptionalJacobian<2, 5> Dcal = std::nullopt,
                   OptionalJacobian<2, 2> Dp = std::nullopt) const;
  ...
  inline Cal3_S2 between(const Cal3_S2& q,
                         OptionalJacobian<5, 5> H1 = std::nullopt,
                         OptionalJacobian<5, 5> H2 = std::nullopt) const {
    if (H1) *H1 = -I_5x5;
    if (H2) *H2 = I_5x5;
