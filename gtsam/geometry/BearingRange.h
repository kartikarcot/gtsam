...
public:
  ...
  static BearingRange Measure(
    ...
    OptionalJacobian<dimension, traits<A1>::dimension> H1 = std::nullopt,
    OptionalJacobian<dimension, traits<A2>::dimension> H2 = std::nullopt) {
...
struct HasBearing {
  ...
  RT operator()(
      const A1& a1, const A2& a2,
      OptionalJacobian<traits<RT>::dimension, traits<A1>::dimension> H1=std::nullopt,
      OptionalJacobian<traits<RT>::dimension, traits<A2>::dimension> H2=std::nullopt) {
