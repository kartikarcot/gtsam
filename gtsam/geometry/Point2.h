...
GTSAM_EXPORT double norm2(const Point2& p, OptionalJacobian<1, 2> H = std::nullopt);

/// distance between two points
GTSAM_EXPORT double distance2(const Point2& p1, const Point2& q,
                 OptionalJacobian<1, 2> H1 = std::nullopt,
                 OptionalJacobian<1, 2> H2 = std::nullopt);
 ...
 * If the circles do not intersect or they are identical, returns std::nullopt.
 ...
 * @return optional Point2 with f and h, std::nullopt if no solution.
 */
