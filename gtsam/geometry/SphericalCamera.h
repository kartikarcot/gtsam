...
class GTSAM_EXPORT SphericalCamera {
 ...
 public:
   ...
   */
  Unit3 project2(const Point3& pw, OptionalJacobian<2, 6> Dpose = std::nullopt,
   ...
   * @return the intrinsic coordinates of the projected point
   */
  Unit3 project2(const Unit3& pwu, OptionalJacobian<2, 6> Dpose = std::nullopt,
   ...
   * @return the intrinsic coordinates of the projected point
   */
  Unit3 project(const Point3& point, OptionalJacobian<2, 6> Dpose = std::nullopt,
                OptionalJacobian<2, 3> Dpoint = std::nullopt) const;
