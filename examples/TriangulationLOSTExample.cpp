...
int main(int argc, char* argv[]) {
  ...
  for (int i = 0; i < nrTrials; i++) {
    ...
    std::optional<Point3> estimateLOST = triangulatePoint3<Cal3_S2>(
    ...
    std::optional<Point3> estimateDLT = triangulatePoint3<Cal3_S2>(
    ...
    std::optional<Point3> estimateDLTOpt = triangulatePoint3<Cal3_S2>(
